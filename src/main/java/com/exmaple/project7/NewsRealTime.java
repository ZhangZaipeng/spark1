...
/**
 * 数据源： kafka 需求： 1.  pv 2.  uv 3.  跳出率 4.  注册用户数 5.  热门板块
 */
public class NewsRealTime {

  /**
   * input data: 2019-03-09 1552120347477 9582 264 movie view 2019-03-09 1552120347477 9659 783
   * tv-show view
   */
   ...
   * 求PV
   *
   * 2019-03-09 1552120347477 9582 264 movie view <2019-03-09_264,1>
   */
  ...
  /**
   * input Data: 2019-03-09 1552120347477 9582 264 movie view 2019-03-09 1552120347477 9582 264
   * movie view 2019-03-09 1552120347477 9583 264 movie view 2019-03-09 1552120347477 9584 264 movie
   * view 2019-03-09 1552120347477 9585 264 movie view
   *
   * 第一步：rdd -> map (2019-03-09,9582,264) (2019-03-09,9582,264) (2019-03-09,9583,264)
   * (2019-03-09,9584,264) (2019-03-09,9585,264)
   *
   * 第二步:rdd -> distinct (2019-03-09,9582,264) (2019-03-09,9583,264) (2019-03-09,9584,264)
   * (2019-03-09,9585,264)
   *
   * 第三步：mapToPair (2019-03-09_264,1) (2019-03-09_264,1) (2019-03-09_264,1) (2019-03-09_264,1)
   *
   * 第四步：reduceByKey (2019-03-09_264,4)
   */
  ...
  /**
   * 2019-03-09 1552120347477 9582 null null register 2019-03-09 1552120347477 9582 null null
   * register 获取当前的用户注册数 过滤出action=register的数据就可以
   *
   *
   * 2019-03-09_register 2019-03-09_register 2019-03-10_register 2019-03-10_register
   */
   ...
   *
   * 第一步：mapToPair 2019-03-09_9582,1
   *
   * 第二步：reduceByKey <2019-03-09_9582,2>
   *
   * 第三步:fileter 过滤count  = 1 的数据
   *
   * 第四步：count
   */
  ...
  /**
   * 2019-03-09 1552120347477 599 152 sport view 第一步：mapToPair (2019-03-09_sport,1)
   *
   * 第二步：reduceByKey
   */
